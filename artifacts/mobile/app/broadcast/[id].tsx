...
const styles = StyleSheet.create({
  ...
  title: { flex: 1, fontSize: 20, fontFamily: "HankenGrotesk_700Bold" },
  ...
  subject: { fontSize: 20, fontFamily: "HankenGrotesk_700Bold", marginBottom: 8 },
  metaRow: { flexDirection: "row", alignItems: "center", gap: 10 },
  badge: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8 },
  badgeText: { fontSize: 13, fontFamily: "HankenGrotesk_500Medium", textTransform: "capitalize" },
  meta: { fontSize: 14, fontFamily: "HankenGrotesk_400Regular" },
  sectionLabel: { fontSize: 13, fontFamily: "HankenGrotesk_600SemiBold", textTransform: "uppercase", letterSpacing: 0.5, marginBottom: 8 },
  body: { fontSize: 15, fontFamily: "HankenGrotesk_400Regular", lineHeight: 22 },
