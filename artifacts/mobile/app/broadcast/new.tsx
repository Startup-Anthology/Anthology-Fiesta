...
const createStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  title: { fontSize: 17, fontFamily: "SpaceGrotesk_600SemiBold", color: colors.text },
  stepIndicator: { flexDirection: "row", justifyContent: "center", gap: 8, marginBottom: Layout.sectionSpacing },
  dot: { width: 8, height: 8, borderRadius: 4, backgroundColor: colors.border },
  dotActive: { backgroundColor: colors.primary, width: 20 },
  stepTitle: { fontSize: 20, fontFamily: "SpaceGrotesk_700Bold", color: colors.text, marginBottom: 20 },
  segLabel: { fontSize: 13, fontFamily: "SpaceGrotesk_600SemiBold", color: colors.textSecondary, marginBottom: 8, marginTop: 14, textTransform: "uppercase" },
  ...
  nextBtnText: { fontSize: 16, fontFamily: "SpaceGrotesk_600SemiBold", color: colors.onPrimary },
  ...
  templateName: { fontSize: 15, fontFamily: "SpaceGrotesk_600SemiBold", color: colors.text },
  ...
  recipientCount: { fontSize: 16, fontFamily: "SpaceGrotesk_700Bold", color: colors.text, marginBottom: 14 },
  ...
  summaryValue: { fontSize: 14, fontFamily: "SpaceGrotesk_600SemiBold", color: colors.text, textTransform: "capitalize", flexShrink: 1, textAlign: "right" },
  ...
  sendBtnText: { fontSize: 16, fontFamily: "SpaceGrotesk_600SemiBold", color: colors.onPrimary },
});
