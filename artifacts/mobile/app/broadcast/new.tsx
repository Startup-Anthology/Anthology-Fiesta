...
const createStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  backText: { fontSize: 16, fontFamily: "HankenGrotesk_400Regular", color: colors.info },
  title: { fontSize: 17, fontFamily: "HankenGrotesk_600SemiBold", color: colors.text },
  stepIndicator: { flexDirection: "row", justifyContent: "center", gap: 8, marginBottom: Layout.sectionSpacing },
  dot: { width: 8, height: 8, borderRadius: 4, backgroundColor: colors.border },
  dotActive: { backgroundColor: colors.primary, width: 20 },
  stepTitle: { fontSize: 20, fontFamily: "HankenGrotesk_700Bold", color: colors.text, marginBottom: 20 },
  segLabel: { fontSize: 13, fontFamily: "HankenGrotesk_600SemiBold", color: colors.textSecondary, marginBottom: 8, marginTop: 14, textTransform: "uppercase" },
  ...
  chipText: { fontSize: 13, fontFamily: "HankenGrotesk_500Medium", color: colors.text, textTransform: "capitalize" },
  ...
  nextBtnText: { fontSize: 16, fontFamily: "HankenGrotesk_600SemiBold", color: colors.onPrimary },
  ...
  templateName: { fontSize: 15, fontFamily: "HankenGrotesk_600SemiBold", color: colors.text },
  templateSubject: { fontSize: 13, fontFamily: "HankenGrotesk_400Regular", color: colors.textSecondary, marginTop: 2 },
  noTemplates: { fontSize: 14, fontFamily: "HankenGrotesk_400Regular", color: colors.textTertiary, textAlign: "center", paddingVertical: 24 },
  ...
  previewLabel: { fontSize: 13, fontFamily: "HankenGrotesk_500Medium", color: colors.textSecondary, textTransform: "capitalize" },
  recipientCount: { fontSize: 16, fontFamily: "HankenGrotesk_700Bold", color: colors.text, marginBottom: 14 },
  ...
  recipientName: { flex: 1, fontSize: 14, fontFamily: "HankenGrotesk_500Medium", color: colors.text },
  recipientEmail: { fontSize: 13, fontFamily: "HankenGrotesk_400Regular", color: colors.textSecondary },
  ...
  summaryLabel: { fontSize: 14, fontFamily: "HankenGrotesk_500Medium", color: colors.textSecondary },
  summaryValue: { fontSize: 14, fontFamily: "HankenGrotesk_600SemiBold", color: colors.text, textTransform: "capitalize", flexShrink: 1, textAlign: "right" },
  ...
  sendBtnText: { fontSize: 16, fontFamily: "HankenGrotesk_600SemiBold", color: colors.onPrimary },
});
