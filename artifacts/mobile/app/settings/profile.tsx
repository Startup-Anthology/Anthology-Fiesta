...
const createStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  emailLabel: { fontSize: 14, fontFamily: "SpaceGrotesk_500Medium", color: colors.textSecondary },
  emailValue: { fontSize: 14, fontFamily: "SpaceGrotesk_400Regular", color: colors.text },
  ...
  saveBtnText: { fontSize: 15, fontFamily: "SpaceGrotesk_600SemiBold", color: colors.onPrimary },
});
