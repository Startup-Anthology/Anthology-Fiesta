...
const createStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  sectionTitle: { fontSize: 13, fontFamily: "SpaceGrotesk_600SemiBold", color: colors.textTertiary, textTransform: "uppercase", letterSpacing: 0.8, marginBottom: 8 },
  sectionSubtitle: { fontSize: 13, fontFamily: "SpaceGrotesk_400Regular", color: colors.textTertiary, marginBottom: 10 },
  ...
  rowLabel: { fontSize: 14, fontFamily: "SpaceGrotesk_500Medium", color: colors.text, flex: 1 },
  rowInput: {
    fontSize: 14,
  ...
  customLabel: { flex: 1, fontSize: 14, fontFamily: "SpaceGrotesk_400Regular", color: colors.text, backgroundColor: colors.surface2, borderRadius: 8, paddingHorizontal: 10, paddingVertical: 8 },
  customUrl: { flex: 2, fontSize: 14, fontFamily: "SpaceGrotesk_400Regular", color: colors.text, backgroundColor: colors.surface2, borderRadius: 8, paddingHorizontal: 10, paddingVertical: 8 },
  notionRow: { paddingHorizontal: Layout.cardPadding, paddingVertical: 12 },
  notionLabel: { fontSize: 12, fontFamily: "SpaceGrotesk_600SemiBold", color: colors.textSecondary, marginBottom: 6, textTransform: "uppercase" },
  notionInput: { fontSize: 13, fontFamily: "SpaceGrotesk_400Regular", color: colors.text, backgroundColor: colors.surface2, borderRadius: 8, paddingHorizontal: 10, paddingVertical: 8 },
});
