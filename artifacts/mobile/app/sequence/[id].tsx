...
const createStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  cancelText: { fontSize: 16, fontFamily: "HankenGrotesk_400Regular", color: colors.info },
  title: { fontSize: 17, fontFamily: "HankenGrotesk_600SemiBold", color: colors.text },
  saveText: { fontSize: 16, fontFamily: "HankenGrotesk_600SemiBold", color: colors.info },
  deleteBtn: { flexDirection: "row", alignItems: "center", gap: 6, alignSelf: "flex-end", marginBottom: 20 },
  deleteText: { fontSize: 14, fontFamily: "HankenGrotesk_500Medium", color: colors.error },
  formGroup: { marginBottom: 22 },
  label: { fontSize: 13, fontFamily: "HankenGrotesk_600SemiBold", color: colors.textSecondary, marginBottom: 8, textTransform: "uppercase" },
  input: { backgroundColor: colors.surface, borderRadius: Layout.inputRadius, padding: Layout.cardPadding, fontSize: 16, fontFamily: "HankenGrotesk_400Regular", color: colors.text },
  ...
  stepNumText: { fontSize: 13, fontFamily: "HankenGrotesk_700Bold", color: colors.info },
  stepInfo: { flex: 1 },
  stepName: { fontSize: 14, fontFamily: "HankenGrotesk_600SemiBold", color: colors.text },
  stepDelay: { fontSize: 12, fontFamily: "HankenGrotesk_400Regular", color: colors.textSecondary, marginTop: 2 },
  ...
  addStepTitle: { fontSize: 15, fontFamily: "HankenGrotesk_600SemiBold", color: colors.text, marginBottom: 14 },
  ...
  templateOptionText: { fontSize: 14, fontFamily: "HankenGrotesk_500Medium", color: colors.text },
  ...
  addBtnText: { fontSize: 14, fontFamily: "HankenGrotesk_600SemiBold", color: colors.onPrimary },
  ...
  enrollText: { fontSize: 13, fontFamily: "HankenGrotesk_400Regular", color: colors.textSecondary },
});
