...
const createStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  saveText: { fontSize: 16, fontFamily: "SpaceGrotesk_600SemiBold", color: colors.info },
  ...
  label: { fontSize: 13, fontFamily: "SpaceGrotesk_600SemiBold", color: colors.textSecondary, marginBottom: 8, textTransform: "uppercase" },
  ...
  sectionTitle: { fontSize: 16, fontFamily: "SpaceGrotesk_600SemiBold", color: colors.text, marginBottom: 14 },
  ...
  stepNumText: { fontSize: 13, fontFamily: "SpaceGrotesk_700Bold", color: colors.info },
  stepInfo: { flex: 1 },
  stepName: { fontSize: 14, fontFamily: "SpaceGrotesk_600SemiBold", color: colors.text },
  ...
  addStepTitle: { fontSize: 15, fontFamily: "SpaceGrotesk_600SemiBold", color: colors.text, marginBottom: 14 },
