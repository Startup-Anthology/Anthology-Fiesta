...
const createStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  avatarText: { fontSize: 26, fontFamily: "SpaceGrotesk_700Bold", color: "#fff" },
  ...
  name: { fontSize: 22, fontFamily: "SpaceGrotesk_700Bold", color: colors.text },
  ...
  relText: { fontSize: 12, fontFamily: "SpaceGrotesk_600SemiBold", textTransform: "capitalize" },
  ...
  priorityText: { fontSize: 12, fontFamily: "SpaceGrotesk_600SemiBold", textTransform: "capitalize" },
  ...
  sectionTitle: { fontSize: 16, fontFamily: "SpaceGrotesk_600SemiBold", color: colors.text, marginBottom: 10 },
  ...
  editBtn: { fontSize: 14, fontFamily: "SpaceGrotesk_600SemiBold", color: colors.info },
  ...
  activityType: { fontSize: 13, fontFamily: "SpaceGrotesk_600SemiBold", color: colors.text, textTransform: "capitalize" },
