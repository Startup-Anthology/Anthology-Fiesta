...
export default function ContactDetailScreen() {
  ...
  const markMut = useMutation({
    ...
    onError: (err: Error) => showAlert("Failed", err.message),
  });
  ...
  const handleDelete = useCallback(() => {
    showAlert("Delete this contact?", "This can't be undone.", [
...
const createStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  subtitle: { fontSize: 14, fontFamily: "HankenGrotesk_400Regular", color: colors.textSecondary, marginTop: 2 },
  ...
  relText: { fontSize: 12, fontFamily: "HankenGrotesk_600SemiBold", textTransform: "capitalize" },
  ...
  priorityText: { fontSize: 12, fontFamily: "HankenGrotesk_600SemiBold", textTransform: "capitalize" },
  ...
  actionText: { fontSize: 12, fontFamily: "HankenGrotesk_500Medium", color: colors.text },
  ...
  infoText: { fontSize: 14, fontFamily: "HankenGrotesk_400Regular", color: colors.textSecondary, flex: 1 },
  ...
  quickText: { fontSize: 14, fontFamily: "HankenGrotesk_500Medium", color: colors.text },
  ...
  seqName: { flex: 1, fontSize: 14, fontFamily: "HankenGrotesk_500Medium", color: colors.text },
  editBtn: { fontSize: 14, fontFamily: "HankenGrotesk_600SemiBold", color: colors.info },
  notesInput: { backgroundColor: colors.surface, borderRadius: Layout.inputRadius, padding: Layout.cardPadding, fontSize: 15, fontFamily: "HankenGrotesk_400Regular", color: colors.text, minHeight: 80, textAlignVertical: "top" },
  notesText: { fontSize: 14, fontFamily: "HankenGrotesk_400Regular", color: colors.textSecondary, lineHeight: 22 },
  emptyActivity: { fontSize: 14, fontFamily: "HankenGrotesk_400Regular", color: colors.textTertiary },
  activityItem: { flexDirection: "row", gap: 10, marginBottom: 14 },
  activityDot: { width: 8, height: 8, borderRadius: 4, marginTop: 6 },
  activityContent: { flex: 1 },
  activityType: { fontSize: 13, fontFamily: "HankenGrotesk_600SemiBold", color: colors.text, textTransform: "capitalize" },
  activityNote: { fontSize: 13, fontFamily: "HankenGrotesk_400Regular", color: colors.textSecondary, marginTop: 2 },
  ...
  editFieldLabel: { width: 70, fontSize: 13, fontFamily: "HankenGrotesk_500Medium", color: colors.textSecondary },
  editFieldInput: { flex: 1, fontSize: 14, fontFamily: "HankenGrotesk_400Regular", color: colors.text, borderBottomWidth: 1, borderBottomColor: colors.borderLight, paddingVertical: 6 },
  ...
  chipSmallText: { fontSize: 12, fontFamily: "HankenGrotesk_500Medium", color: colors.text, textTransform: "capitalize" },
  ...
  fileName: { flex: 1, fontSize: 13, fontFamily: "HankenGrotesk_400Regular", color: colors.text },
});
