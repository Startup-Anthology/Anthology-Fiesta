...
const createStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  statusText: { fontSize: 12, fontFamily: "SpaceGrotesk_600SemiBold", textTransform: "uppercase" },
  betaBadge: { backgroundColor: colors.accent + "20", paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6 },
  betaText: { fontSize: 11, fontFamily: "SpaceGrotesk_700Bold", color: colors.accent },
