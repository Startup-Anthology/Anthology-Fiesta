...
const createStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  statusText: { fontSize: 12, fontFamily: "HankenGrotesk_600SemiBold", textTransform: "uppercase" },
  betaBadge: { backgroundColor: colors.accent + "20", paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6 },
  betaText: { fontSize: 11, fontFamily: "HankenGrotesk_700Bold", color: colors.accent },
  sourceLabel: { fontSize: 13, fontFamily: "HankenGrotesk_400Regular", color: colors.textTertiary, textTransform: "capitalize" },
  ...
  statusChipText: { fontSize: 13, fontFamily: "HankenGrotesk_500Medium", color: colors.text },
  ...
  actionText: { fontSize: 13, fontFamily: "HankenGrotesk_500Medium", color: colors.text },
