...
const createStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  sendText: { fontSize: 16, fontFamily: "HankenGrotesk_600SemiBold", color: colors.info },
  ...
  fieldLabel: { width: 60, fontSize: 14, fontFamily: "HankenGrotesk_500Medium", color: colors.textSecondary },
  fieldValue: { flex: 1, fontSize: 15, fontFamily: "HankenGrotesk_400Regular", color: colors.text },
  ...
  toText: { fontSize: 15, fontFamily: "HankenGrotesk_500Medium", color: colors.text },
  subjectInput: { flex: 1, fontSize: 15, fontFamily: "HankenGrotesk_400Regular", color: colors.text },
  ...
  templateBtnText: { fontSize: 14, fontFamily: "HankenGrotesk_500Medium", color: colors.info },
  ...
  templateName: { fontSize: 14, fontFamily: "HankenGrotesk_500Medium", color: colors.text },
  templateAudience: { fontSize: 12, fontFamily: "HankenGrotesk_400Regular", color: colors.textTertiary, textTransform: "capitalize" },
  noTemplates: { padding: Layout.cardPadding, fontSize: 14, fontFamily: "HankenGrotesk_400Regular", color: colors.textTertiary },
