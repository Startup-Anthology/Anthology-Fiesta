...
const createStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  avatarText: { fontSize: 20, fontFamily: "HankenGrotesk_700Bold", color: colors.accent },
  displayName: { fontSize: 17, fontFamily: "HankenGrotesk_600SemiBold", color: colors.text },
  role: { fontSize: 12, fontFamily: "HankenGrotesk_400Regular", color: colors.textTertiary, textTransform: "capitalize" },
  sectionHeader: {
    fontSize: 11,
