...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 24, fontFamily: "HankenGrotesk_700Bold" },
  ...
  tabText: { fontSize: 13, fontFamily: "HankenGrotesk_500Medium" },
  ...
  cardSubtitle: { fontSize: 13, fontFamily: "HankenGrotesk_400Regular", marginTop: 2 },
  cardDate: { fontSize: 12, fontFamily: "HankenGrotesk_400Regular", marginTop: 2 },
  audienceBadge: { paddingHorizontal: 8, paddingVertical: 2, borderRadius: 6, alignSelf: "flex-start", marginTop: 4 },
  audienceText: { fontSize: 11, fontFamily: "HankenGrotesk_500Medium", textTransform: "capitalize" },
