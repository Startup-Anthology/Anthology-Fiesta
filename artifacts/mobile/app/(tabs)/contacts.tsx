    ...
    return (
      <View style={[styles.container, { paddingTop: topPad, backgroundColor: colors.background }]}>
        <View style={{ padding: 16 }}>
          {[1, 2, 3, 4, 5, 6].map((i) => <SkeletonListItem key={i} />)}
        </View>
      </View>
    );
  }
...
const styles = StyleSheet.create({
  ...
  input: { borderRadius: Layout.inputRadius, padding: Layout.cardPadding, fontSize: 16, fontFamily: "HankenGrotesk_400Regular" },
