...
const styles = StyleSheet.create({
  ...
  agentName: { fontSize: 12, fontFamily: "HankenGrotesk_600SemiBold" },
  messageText: { fontSize: 15, fontFamily: "HankenGrotesk_400Regular", lineHeight: 22 },
  ...
  emptyChatTitle: { fontSize: 20, fontFamily: "HankenGrotesk_600SemiBold", marginBottom: 8 },
  emptyChatSub: { fontSize: 14, fontFamily: "HankenGrotesk_400Regular", textAlign: "center", lineHeight: 20 },
});
