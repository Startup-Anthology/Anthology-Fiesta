              ...
              return (
                ...
                >
                  <Text style={[
                    ...
                    isToday && !isSelected && { color: colors.primary, fontFamily: "HankenGrotesk_700Bold" },
                  ]}>
                    {d ? d.getDate() : ""}
                  </Text>
                </Pressable>
...
const styles = StyleSheet.create({
  ...
  backText: { fontSize: 16, fontFamily: "HankenGrotesk_500Medium" },
  ...
  weekLabel: { fontSize: 15, fontFamily: "HankenGrotesk_600SemiBold" },
  todayBtn: { alignSelf: "center", paddingHorizontal: 14, paddingVertical: 5, borderRadius: 12, marginBottom: 8 },
  todayBtnText: { fontSize: 13, fontFamily: "HankenGrotesk_600SemiBold" },
  center: { flex: 1, justifyContent: "center", alignItems: "center" },
  scrollArea: { flex: 1 },
  scrollContent: { paddingHorizontal: Layout.screenPadding },
  dayViewTitle: { fontSize: 22, fontFamily: "Lato_700Bold", marginBottom: 20, marginTop: 4 },
  ...
  emptyDayText: { fontSize: 16, fontFamily: "HankenGrotesk_500Medium" },
  ...
  emptyDayAddText: { fontSize: 14, fontFamily: "HankenGrotesk_600SemiBold" },
  ...
  eventTitle: { fontSize: 15, fontFamily: "HankenGrotesk_600SemiBold", flex: 1, marginRight: 8 },
  eventTime: { fontSize: 13, fontFamily: "HankenGrotesk_500Medium" },
  eventDesc: { fontSize: 13, fontFamily: "HankenGrotesk_400Regular", marginTop: 4 },
  eventMeta: { flexDirection: "row", gap: 8, marginTop: 8, flexWrap: "wrap" },
  typeBadge: { paddingHorizontal: 8, paddingVertical: 2, borderRadius: 6 },
  typeText: { fontSize: 11, fontFamily: "HankenGrotesk_600SemiBold", textTransform: "capitalize" },
  linkBadge: { flexDirection: "row", alignItems: "center", gap: 4 },
  linkText: { fontSize: 12, fontFamily: "HankenGrotesk_500Medium" },
  fab: {
  ...
  pickerSheet: { borderRadius: 16, padding: 20, width: "100%", maxWidth: 360, ...Layout.shadow.lg },
  pickerHeader: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginBottom: 16 },
  pickerMonthLabel: { fontSize: 17, fontFamily: "HankenGrotesk_600SemiBold" },
  pickerWeekRow: { flexDirection: "row", alignItems: "center", marginBottom: 4 },
  pickerWeekDay: { flex: 1, textAlign: "center", fontSize: 12, fontFamily: "HankenGrotesk_600SemiBold" },
  ...
  pickerDayText: { fontSize: 14, fontFamily: "HankenGrotesk_500Medium" },
  ...
  pickerTodayText: { fontSize: 14, fontFamily: "HankenGrotesk_600SemiBold" },
});
const modalStyles = StyleSheet.create({
  ...
  cancelText: { fontSize: 16, fontFamily: "HankenGrotesk_500Medium" },
  headerTitle: { fontSize: 17, fontFamily: "HankenGrotesk_600SemiBold" },
  saveText: { fontSize: 16, fontFamily: "HankenGrotesk_600SemiBold" },
  form: { flex: 1 },
  formContent: { padding: Layout.screenPadding, gap: 4 },
  label: { fontSize: 13, fontFamily: "HankenGrotesk_600SemiBold", marginTop: 14, marginBottom: 8 },
  input: { borderRadius: Layout.inputRadius, padding: Layout.cardPadding, fontSize: 15, fontFamily: "HankenGrotesk_400Regular" },
  typeRow: { flexDirection: "row", gap: 8, flexWrap: "wrap" },
  typeChip: { paddingHorizontal: 14, paddingVertical: 8, borderRadius: Layout.chipRadius, borderWidth: 1 },
  typeChipText: { fontSize: 13, fontFamily: "HankenGrotesk_500Medium", textTransform: "capitalize" },
  ...
  pickerName: { fontSize: 14, fontFamily: "HankenGrotesk_500Medium" },
  pickerSub: { fontSize: 12, fontFamily: "HankenGrotesk_400Regular", marginTop: 2 },
});
