...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 22, fontFamily: "Lato_700Bold" },
  subtitle: { fontSize: 13, fontFamily: "HankenGrotesk_400Regular", marginTop: 2 },
  ...
  menuLabel: { flex: 1, fontSize: 16, fontFamily: "HankenGrotesk_500Medium" },
});
