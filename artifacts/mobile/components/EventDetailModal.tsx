...
const createStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  headerTitle: { fontSize: 20, fontFamily: "HankenGrotesk_700Bold", color: colors.text },
  scroll: { flex: 1 },
  titleRow: {
    flexDirection: "row",
    alignItems: "center",
  ...
  typeBadgeText: { fontSize: 13, fontFamily: "HankenGrotesk_600SemiBold", textTransform: "capitalize" },
  eventTitle: { fontSize: 22, fontFamily: "HankenGrotesk_700Bold", color: colors.text, marginBottom: 20 },
  timeCard: {
  ...
  timeLabel: { fontSize: 11, fontFamily: "HankenGrotesk_600SemiBold", color: colors.textTertiary, textTransform: "uppercase" },
  timeValue: { fontSize: 14, fontFamily: "HankenGrotesk_400Regular", color: colors.text },
  ...
  durationText: { fontSize: 12, fontFamily: "HankenGrotesk_600SemiBold", color: colors.accent },
  details: { gap: 0 },
  detailSection: {
    backgroundColor: colors.surface,
    borderRadius: 12,
  ...
  linkText: { fontSize: 14, fontFamily: "HankenGrotesk_400Regular", color: colors.text },
  form: { gap: 12 },
  label: {
    fontSize: 12,
    fontFamily: "HankenGrotesk_600SemiBold",
  ...
  typeChipText: { fontSize: 13, fontFamily: "HankenGrotesk_400Regular", color: colors.textSecondary, textTransform: "capitalize" },
  ...
  cancelBtnText: { fontSize: 14, fontFamily: "HankenGrotesk_600SemiBold", color: colors.textSecondary },
  saveBtn: {
    flex: 1,
    flexDirection: "row",
    alignItems: "center",
  ...
  saveBtnText: { fontSize: 14, fontFamily: "HankenGrotesk_600SemiBold", color: colors.onPrimary },
});
