...
const createStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  date: { fontSize: 12, fontFamily: "HankenGrotesk_400Regular", color: colors.textTertiary },
  details: { gap: 16 },
  detailSection: {
  ...
  empty: { fontSize: 14, fontFamily: "HankenGrotesk_400Regular", color: colors.textTertiary, marginTop: 10 },
  gmailBtn: {
    flexDirection: "row",
    alignItems: "center",
    gap: 8,
  ...
  gmailBtnText: { fontSize: 14, fontFamily: "HankenGrotesk_600SemiBold", color: colors.info },
  form: { gap: 12 },
  label: {
    fontSize: 12,
    fontFamily: "HankenGrotesk_600SemiBold",
