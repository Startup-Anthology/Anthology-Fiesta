...
const styles = StyleSheet.create({
  ...
  bannerAgent: { fontSize: 11, fontFamily: "HankenGrotesk_600SemiBold", marginBottom: 2 },
  bannerTitle: { fontSize: 14, fontFamily: "HankenGrotesk_600SemiBold", marginBottom: 2 },
  bannerDesc: { fontSize: 12, fontFamily: "HankenGrotesk_400Regular", lineHeight: 16 },
